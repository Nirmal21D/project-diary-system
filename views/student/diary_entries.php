...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="index.php?page=add_diary_entry" class="btn btn-primary btn-sm">
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <div class="alert alert-info">
                    ...
                    <a href="index.php?page=add_diary_entry" class="alert-link">Create your first diary entry</a>.
                </div>
            <?php endif; ?>
        </div>
    </div>
