...
<head>
    ...
    <title><?php echo isset($pageTitle) ? $pageTitle : 'Admin Dashboard'; ?> - Project Diary System</title>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="index.php?page=institutional_info" class="list-group-item list-group-item-action <?php echo $page === 'institutional_info' ? 'active' : ''; ?>">
                            <i class="fas fa-university"></i> Institutional Info
                        </a>
